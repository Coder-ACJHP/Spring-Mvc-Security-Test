...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/accessDenied.css">
...
<body>
  <div id="spam">
    ...
    <p>Secure content is being accessed, you doesn't have permission to access this page!<br/><br/>
    <small>---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</small></p>
  </div>
  <div align="center">
  <button type="button" id="submit" class="btn btn-warning">Go back!</button>
  </div>
  <br><br>
  <div id="gears">
