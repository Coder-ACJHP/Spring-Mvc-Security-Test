...
<spring:url value="/resources/css/bootstrap.min.css" var="bootsrapMinCss"/>
			...
			<div class="col-md-6">
				...
				<c:if test="${pageContext.request.userPrincipal.name != null }">
					...
					<form action="${logoutUrl}" method="POST">
						...
						<button type="submit" class="btn btn-primary" onclick="location.href='/admin'">Go to admin page</button>
